...
class BleDeviceInteractor {
  ...
  Future<List<int>> readCharacteristic(
    ...
    try {
      ...
      // _logMessage('Error occured when reading ${characteristic.characteristicId} : $e',);
      // ignore: avoid_print
      print(s);
      rethrow;
    }
  ...
  Future<void> writeCharacterisiticWithoutResponse(
    ...
    try {
      ...
      print('Write without response value: $value to ${characteristic.characteristicId}');
      // _logMessage('Write without response value: $value to ${characteristic.characteristicId}');
    } on Exception catch (e, s) {
       print('Error occured when writing ${characteristic.characteristicId} : $e',);
      // ignore: avoid_print
      print(s);
      rethrow;
    }
